...
DOM.li = function () {
 ...
 'html,head,script,style,link,body,div,ul,ol,li,a,i,p,strong,sup,sub,br,span,img,caption,table,thead,tbody,tr,th,td,h1,h2,h3,h4,h5,h6,select,option,label,input,textarea,button,iframe,audio,object,video,canvas,form,fieldset,legend,'.split(/,/).forEach(function (tag) {
    DOM[tag] = function () {
