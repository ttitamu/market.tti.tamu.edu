...
TTI.Models.MultiModelBCA = function (spec) {
  ...
  var travelImpacts = function(args)
  {
    ...
    function run(x) {
      ...
      var fnList = {
        ...
        "Operation Cost-Rail": function (args) {
          return args[0] * args[1]; //Fuel cost, gallons
        },
        "Environmental Cost-Rail": function (args) {
          return args[0] * args[1];
        },
        "Towboat Cost-Barge": function (args) {
          return args[0] * args[1] / args[2];
        },
        "Dry Barge Cost-Barge": function (args) {
          return args[0] * args[1] * (1 - args[2]);
        },
        "Tanker Barge Cost-Barge": function (args) {
          return args[0] * args[1] * args[2];
        },
        "Barge Tons-Barge": function (args) {
          return args[0] * args[1];
        },
        "Trucks-Barge": function (args) {
          return args[0] / args[1];
        },
        "Truck VHT-Barge": function (args) {
          return args[0] * args[1];
        },
    ...
    function netChange(x,o) {
      ...
      var output = {};
      output.RowIndex = years;
      output.Headers = ["VHT-Truck", "Truck VHT-Rail", "Truck VHT-Barge"];
      output.Rows = [];
      function computeRow(i, h, lf, la) {
        var row = {};
        h.forEach(function (k) {
      ...
      var argsList = {
        "VHT-Truck": function (r, j) {
          return [getData(o.project.Rows, j, "VHT-Truck"), 0];
        },
        "Truck VHT-Rail": function (r, j) {
          return [getData(o.project.Rows, j, "VHT-Passenger"), 0];
        },
        "Truck VHT-Barge": function (r, j) {
          return [fn(r, "VHT-Truck"), 0];
        }
      }
      output.Rows = indexes.map(function (i) {
        return computeRow(i, output.Headers, fnList, argsList);
  ...
  var benefits = function (args) {
    ...
    var run = function(o)
    {
      ...
      var argsList = {
        ...
        "Freight Time Cost-Truck": function (r, j) {
          return [dFactor[j]].concat(getData(rowsF, j, ["Total-Truck"]));
        },
        "Freight Time Cost-Barge": function (r, j) {
          return [dFactor[j]].concat(getData(rowsF, j, ["Total-Barge"]));
        },
        "Freight Time Cost-Rail": function (r, j) {
          return [dFactor[j]].concat(getData(rowsF, j, ["Total-Rail"]));
        }
      };
      r.Headers = Object.keys(fnList);
      r.Rows = indexes.map(function (i) {
  ...
  //  var mix = args.input.commodityMix;
    ...
    var run = function(o)
    {
      ...
      var fnList = {
        ...
        "Total-Truck": function (args) {
          var sum = args.reduce(function (p, c, i, a) { return p + c });
          return sum;
        },

        "Total-Rail": function (args) {
          var sum = args.reduce(function (p, c, i, a) { return p + c });
          return sum;
        },
        "Total-Barge": function (args) {
          var sum = args.reduce(function (p, c, i, a) { return p + c });
          return sum;
        }
      };
      ...
      h1.forEach(function (k) {
        kn = k+"-Truck";
        fnList[kn] = function (args) {
          // if (count++<43){
          //    console.log("The %s is %f",k,args[0] * args[1] *args[2]* args[3]*(args[4]+ args[5]*args[6]+ args[7]*args[8]));
          // }
          return args[0] * args[1] *args[2]* args[3]*(args[4]+ args[5]*args[6]+ args[7]*args[8]);
        };
        argsList[kn] = function (r, j) { return [r["VHT-Truck"], tonsPerVehicle, mix.truck[k], cost[k],ctcFactor,perishCost[k],perishCostFactor,jitCost[k],jitCostFactor]; };
      });
      h1.forEach(function (k) {
        kn = k+"-Rail";
        fnList[kn] = function (args) {
        ...
        argsList[kn] = function (r, j) { return [r["Truck VHT-Rail"], tonsPerVehicle, mix.rail[k], cost[k],ctcFactor,perishCost[k],perishCostFactor,jitCost[k],jitCostFactor]; };
      });
      h1.forEach(function (k) {
        kn = k+"-Barge"
        fnList[kn] = function (args) {
        ...
        argsList[kn] = function (r, j) { return [r["Truck VHT-Barge"], tonsPerVehicle, mix.barge[k], cost[k],ctcFactor,perishCost[k],perishCostFactor,jitCost[k],jitCostFactor]; };
      });
  ...
  var computeResults = function (args) {
    ...
    },
    {
      ...
      category: 'Benefits',
      data: benefits,
      items: ['Freight Time Cost-Truck'],
      factor:  [1]
    },
    {
      name: 'Rail Freight Time Cost Savings',
      category: 'Benefits',
      data: benefits,
      items: ['Freight Time Cost-Rail'],
      factor:  [1]
    },
    {
      name: 'Barge Freight Time Cost Savings',
      category: 'Benefits',
      data: benefits,
      items: ['Freight Time Cost-Barge'],
      factor:  [1]
    },
    {
      name: 'Business Output',
